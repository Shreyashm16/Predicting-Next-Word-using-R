blog <- readLines("HC/en_US/en_US.blogs.txt",skipNul = TRUE, warn = TRUE)
news <- readLines("HC/en_US/en_US.news.txt",skipNul = TRUE, warn = TRUE)
twitter <- readLines("HC/en_US/en_US.twitter.txt",skipNul = TRUE, warn = TRUE)
